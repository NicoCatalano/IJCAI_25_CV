...
%-------------------------------------------------------------------------------
\name{Nico Catalano}{}
%\position{PhD Candidate{\enskip\cdotp\enskip}Program}
\address{Politecnico di Milano, Piazza Leonardo da Vinci 32, 20133 Milano }

%\mobile{+1 000-000-0000}
\email{nico.catalano@polimi.it}
%\homepage{www.mywebsite.com}
%\github{mygithub}
\linkedin{linkedin.com/in/nicocatalano}
% \gitlab{my-gitlab-id}
