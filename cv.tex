...
\address{Artificial Intelligence and Robotics Lab (AIRLab) \\ Department of Electronics, Information, and Bioengineering (DEIB) \\ Politecnico di Milano, Milan, Italy }

%\mobile{+1 000-000-0000}
\email{nico.catalano@polimi.it}
%\homepage{www.mywebsite.com}
%\github{mygithub}
\linkedin{nicocatalano}
% \gitlab{my-gitlab-id}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@twitterhandle}
% \skype{skype-id}
% \reddit{reddit-id}
\scholar{ZrGxR2YAAAAJ}%scholar.google.com/citations?user=ZrGxR2YAAAAJ&hl=it}
...
\makecvfooter
  {February 2025}
  {Nico Catalano ~~~·~~~ Curriculum Vitae}
  {\thepage}
...
\input{cv/conference_reviwer.tex}
